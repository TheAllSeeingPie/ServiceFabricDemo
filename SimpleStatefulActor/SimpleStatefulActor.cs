...
namespace SimpleStatefulActor
{
    ...
    /// </remarks>
    internal class SimpleStatefulActor : StatefulActor<SimpleStatefulActor.ActorState>, ISimpleStatefulActor
    {
        /// <summary>
        ...
        internal sealed class ActorState
        {
            ...
            {
                return string.Format(CultureInfo.InvariantCulture, "SimpleStatefulActor.ActorState[Count = {0}]", Count);
            }
        }
        ...
        [Readonly]
        Task<int> ISimpleStatefulActor.GetCountAsync()
        {
        ...
        Task ISimpleStatefulActor.SetCountAsync(int count)
        {
